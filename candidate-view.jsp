...
retrive();
//+" "+rs1.getString(2)+" "+rs1.getString(3)+" "+rs1.getString(4)+" "+rs1.getString(5)+" "+rs1.getString(6)+" "+rs1.getString(7)+" "+rs1.getString(8)+" "+rs1.getString(9)
		            ...
		            <div class="wizard-container">
		                ...
		                <div class="row">
		                  ...
		                  <div class="wizard-header">
		                        	<hr><h3 class="wizard-title">Personal Deatails</h3><hr>
		                   ...
		                   <div class="col-sm-3">
							...
							<div class="col-sm-8 col-sm-offset-1">
								  <p ><strong>CandidateName:</strong><b> <%= rs1.getString(2) %></b></p>
													...
													<p ><strong>ratings:</strong><b>      3</b></p>
													<p ><strong>comments:</strong><b>      good</b></p>
						 ...
						 <div class="row">
							<div class="wizard-header">
		                        		<hr><h3 class="wizard-title">Educational Deatails</h3><hr>
